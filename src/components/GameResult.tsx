    ...
    if (winningBets.length) {
      ...
      return (
        <div tabIndex={0} className="flex justify-center items-center flex-col mb-12 mt-16">
          ...
          <div className="text-primary text-2xl">YOU WIN <span className="text-white">{winAmount}</span> </div>
        </div>
      );
      ...
      return (
        <div tabIndex={0} className="flex justify-center items-center flex-col mb-12 mt-16">
          ...
          <div className="text-primary text-2xl">YOU LOST <span className="text-white">{lossAmount}</span> </div>
        </div>
      );
    }else{
      ...
      return (
        <div tabIndex={0} className="flex justify-center items-center flex-col mb-12 mt-16">
          {move && <div className="text-4xl font-bold text-blue-300">{move} TIED</div>}
